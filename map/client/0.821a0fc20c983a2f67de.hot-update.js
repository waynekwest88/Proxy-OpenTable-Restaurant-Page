...
var TopTags = function TopTags(props) {
  ...
  return _react2.default.createElement(
    'table',
    { className: 'TagRow', style: { marginTop: '15px', marginBottom: '15px', marginRight: '450px', marginLeft: '150px' } },
        ...
        props.restaurant.topTags.map(function (tag, index) {
          return _react2.default.createElement(
            ...
            { key: index, style: { border: '1px solid black', backgroundClip: 'padding-box',
                borderRadius: '15px', padding: '10px', fontColor: 'grey', font: '14px arial' } },
            tag
          );
        })
      )
